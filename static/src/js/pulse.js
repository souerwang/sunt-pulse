odoo.define("sunt-pulse", function(require) {
    "use strict";
    var exports = {};
    ...
    var bus_bus = require('bus.Longpolling');
    ...
    bus_bus.ERROR_RETRY_DELAY = 10000;
    ...
    bus_bus.Bus.include({
        init_bus: function(pos, sync_server) {
            ...
            this.longpolling_connection = new exports.LongpollingConnection(
                this.pos,
                this
            );
        ...
        poll: function(address) {
            ...
            session
                .rpc(serv_adr + "/longpolling/poll", data, {
                    shadow: true,
                    timeout: 60000,
                })
                .then(
